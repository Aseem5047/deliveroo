...
const BasketScreen = () => {
    ...
    return (
        <SafeAreaView className="pt-2 flex-1 grow h-screen bg-white divide-y divide-gray-200">
            <View className="flex-1 bg-gray-100">
                ...
                <View className="p-5 bg-white mt-5 space-y-4">
                    ...
                    <TouchableOpacity className="rounded-lg bg-[#00CCBB] p-3" onPress={() => navigation.navigate('PreparingOrderScreen')}>
